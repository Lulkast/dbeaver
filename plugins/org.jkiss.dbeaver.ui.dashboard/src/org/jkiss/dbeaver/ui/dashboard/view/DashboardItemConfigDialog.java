...
public class DashboardItemConfigDialog extends BaseDialog {
    ...
    {
        super(shell, UIDashboardMessages.dashboard_item_config_dialog_dashboard_title + " [" + dashboardContainer.getDashboardTitle() + "]", null);
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        {
            Group infoGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_item_config_dialog_dashboard_info_label, 4, GridData.FILL_HORIZONTAL, 0);

            //UIUtils.createLabelText(infoGroup, "ID", dashboardConfig.getDashboardDescriptor().getId(), SWT.BORDER | SWT.READ_ONLY);
            UIUtils.createLabelText(infoGroup, UIDashboardMessages.dashboard_item_config_dialog_dashboard_name_label, dashboardConfig.getDashboardDescriptor().getName(), SWT.BORDER | SWT.READ_ONLY)
                .setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, true, false, 3, 1));

            UIUtils.createControlLabel(infoGroup, UIDashboardMessages.dashboard_item_config_dialog_dashboard_description_label).setLayoutData(new GridData(GridData.VERTICAL_ALIGN_BEGINNING));
            ...
            if (SHOW_QUERIES_BUTTON) {
                ...
                queriesButton.setText(UIDashboardMessages.dashboard_item_config_dialog_sql_queries_button);
                    ...
                    public void widgetSelected(SelectionEvent e) {
                        ...
                        if (serviceSQL != null) {
                            serviceSQL.openSQLViewer(
                                ...
                                UIDashboardMessages.dashboard_item_config_dialog_dashboard_read_queries_label,
                                UIIcon.SQL_SCRIPT,
                                sql.toString(),
                                false, false);
                        }
        ...
        {
            Group updateGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_item_config_dialog_dashboard_update_label, 2, GridData.FILL_HORIZONTAL, 0);

            Text updatePeriodText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dashboard_item_config_dialog_dashboard_update_period_label, String.valueOf(dashboardConfig.getUpdatePeriod()), SWT.BORDER, new GridData(GridData.FILL_HORIZONTAL));
            ...
            Text maxItemsText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dashboard_item_config_dialog_dashboard_maximum_items_label, String.valueOf(dashboardConfig.getMaxItems()), SWT.BORDER, new GridData(GridData.FILL_HORIZONTAL));
...
*/
        ...
        {
            Group viewGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_item_config_dialog_dashboard_view_title, 2, GridData.FILL_HORIZONTAL, 0);

            Combo typeCombo = UIUtils.createLabelCombo(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_dashboard_view_label, UIDashboardMessages.dashboard_item_config_dialog_dashboard_view_description, SWT.BORDER | SWT.READ_ONLY);
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_dashboard_show_legend_label, UIDashboardMessages.dashboard_item_config_dialog_dashboard_show_legend_description, dashboardConfig.isLegendVisible(), 2)
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_dashboard_show_grid_label, UIDashboardMessages.dashboard_item_config_dialog_dashboard_show_grid_description, dashboardConfig.isGridVisible(), 2)
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_dashboard_show_domain_axis_label, UIDashboardMessages.dashboard_item_config_dialog_dashboard_show_domain_axis_description, dashboardConfig.isDomainTicksVisible(), 2)
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_dashboard_show_range_axis_label, UIDashboardMessages.dashboard_item_config_dialog_dashboard_show_range_axis_description, dashboardConfig.isDomainTicksVisible(), 2)
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
...
*/
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        createButton(parent, IDialogConstants.CANCEL_ID, UIDashboardMessages.dashboard_item_config_dialog_configuration_label, false).addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
