...
public class DashboardEditDialog extends BaseDialog {
    ...
    {
        super(shell, UIDashboardMessages.dashboard_edit_dialog_dashboard_title + " [" + dashboardDescriptor.getName() + "]", null);
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        if (readOnly) {
            UIUtils.createInfoLabel(composite, UIDashboardMessages.dashboard_edit_dialog_read_only_message);
        }

        {
            Group infoGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_edit_dialog_info_group_main_info_label, 4, GridData.FILL_HORIZONTAL, 0);

            idText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dashboard_edit_dialog_info_group_id_label, dashboardDescriptor.getId(), SWT.BORDER | baseStyle);
            ...
            nameText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dashboard_edit_dialog_info_group_name_label, dashboardDescriptor.getName(), SWT.BORDER | baseStyle);
            ...
            {
                UIUtils.createControlLabel(infoGroup, UIDashboardMessages.dashboard_edit_dialog_info_group_database_label);
                ...
                UIUtils.createPushButton(dbSelectorPanel, UIDashboardMessages.dashboard_edit_dialog_select_button, null, new SelectionAdapter() {
                    @Override
...
//                .setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, true, false, 3, 1));
            dataTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_data_type_label, UIDashboardMessages.dashboard_edit_dialog_data_type_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            calcTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_calc_type_label, UIDashboardMessages.dashboard_edit_dialog_calc_type_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            valueTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_value_type_label, UIDashboardMessages.dashboard_edit_dialog_value_type_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            intervalCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_interval_label, UIDashboardMessages.dashboard_edit_dialog_interval_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            fetchTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_fetch_type_label, UIDashboardMessages.dashboard_edit_dialog_fetch_type_description, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            descriptionText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dashboard_edit_dialog_description_label, CommonUtils.notEmpty(dashboardDescriptor.getDescription()), SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.V_SCROLL | baseStyle);
...

        {
            ...
            UIUtils.createInfoLabel(sqlGroup, UIDashboardMessages.dashboard_edit_dialog_line_separator_info_label);
        ...
        {
            Group updateGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_edit_dialog_renderind_label, 2, GridData.FILL_HORIZONTAL, 0);

            viewTypeCombo = UIUtils.createLabelCombo(updateGroup, UIDashboardMessages.dashboard_edit_dialog_default_view_label, UIDashboardMessages.dashboard_edit_dialog_dashboard_view_label, SWT.BORDER | SWT.READ_ONLY);
            ...
            updatePeriodText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dashboard_edit_dialog_update_period_ms_label, String.valueOf(dashboardDescriptor.getUpdatePeriod()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
            maxItemsText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dashboard_edit_dialog_maximum_items_label, String.valueOf(dashboardDescriptor.getMaxItems()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
