...
public class DashboardAddDialog extends BaseDialog {
    ...
    public DashboardAddDialog(Shell parentShell, DashboardViewConfiguration viewConfiguration) {
        super(parentShell, UIDashboardMessages.dashboard_add_dialog_add_dashboard_label, null);
...
//        listViewer.getControl().setLayoutData(new GridData(GridData.FILL_BOTH));
        ...
        UIUtils.createTableColumn(table, SWT.LEFT, UIDashboardMessages.dashboard_add_dialog_table_column_dashboard_name);
        UIUtils.createTableColumn(table, SWT.LEFT, UIDashboardMessages.dashboard_add_dialog_table_column_dashboard_description);
        ...
        table.addPaintListener(e -> {
            if (table.getItemCount() == 0) {
                UIUtils.drawMessageOverControl(table, e, UIDashboardMessages.dashboard_add_dialog_no_more_dashboards_message + viewConfiguration.getDataSourceContainer().getDriver().getName(), 0);
            }
        });
